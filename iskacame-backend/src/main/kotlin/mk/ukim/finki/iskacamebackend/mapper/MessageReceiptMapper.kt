...
/**
 * Mapper for converting [ChatRoomReceipt] entities to DTOs.
 */
@Mapper(componentModel = "spring")
interface MessageReceiptMapper {

    /**
     * Maps a [ChatRoomReceipt] entity to a [MessageReceiptDto].
     *
     * @param receipt the message receipt entity
     * @return mapped receipt dto
     */
    @Mapping(target = "recipientId", source = "recipient.id")
    fun toMessageReceiptDto(receipt: ChatRoomReceipt): MessageReceiptDto
}